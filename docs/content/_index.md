---
title: "dummy"
description: "A command line for DummyJSON fake data API."
heroTitle: "dummyjson, from the command line"
heroLead: "A command line for DummyJSON fake data API. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
dummy links <path>           # the pages it links to, each addressable
dummy serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading dummyjson by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address dummyjson as
  `dummyjson://` URIs and follow links across sites. See
