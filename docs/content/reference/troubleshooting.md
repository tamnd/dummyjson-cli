...
Most of these come down to network reality or how dummyjson serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

dummyjson rate-limits like any public site. dummy already paces
...
Where a surface is gated, dummy reads a cookie or token you supply
...
`dummy`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what dummy actually did
