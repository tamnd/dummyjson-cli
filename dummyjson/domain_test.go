...
// HTTP behaviour is covered in dummyjson_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "dummyjson://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("dummyjson", "about")
	if err != nil || got.String() != "dummyjson://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want dummyjson://page/about", got.String(), err)
	}
}
